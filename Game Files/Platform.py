...
class Platform(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = self.surface.get_rect(center = (740, random.randint(80, 400))) # random spawn locations on the y-axis; always spawn them on the right side of the screen
